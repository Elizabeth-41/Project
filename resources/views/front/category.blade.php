...
@extends('layouts.app')
@section('title', 'Category Center Poliban')
@section('content')
                            ...
                            <div class="card-detail flex flex-col gap-2">  
                                ...
                                <div class="flex items-center gap-1">  
                                    ...
                                    <span class="font-medium text-aktiv-grey">
                                        {{ $itemNewWorkshop->time_at ? date('h:i A', strtotime($itemNewWorkshop->time_at)) : 'Waktu tidak tersedia' }}
                                    </span>                                 
                                </div>  
                            </div>
                            <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-none">  
